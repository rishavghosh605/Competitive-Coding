...
We can do this faser by applying a bitmask over all the even bits, and another one over all the odd bits.
...
if __name__=="__main__":
    ...
    print("The swapped value: ",bin(swap_bits1(x)))
    print("The swapped value: ",bin(swap_bits2(x)))
